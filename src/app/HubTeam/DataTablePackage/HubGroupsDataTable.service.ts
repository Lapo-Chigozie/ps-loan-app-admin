...
export class HubGroupsDataTableService 
{
  ...
  public onMaxRetrival(event:any):void
  {
      ...
      this.GetAllData(this.AcctId,  this.SearchData);
  }
  ...
  public async GetAllData(ClientId:any , PagenationFilter:any): Promise<void> 
  {
       try
       {
                // let items: Item[] = [];
               ...
               //  <li *ngxRange="let value from 0 to 20 by 5">
                ...
                await this.LapoLoanService.GetHubTeamList(PagenationFilter).subscribe({
                next:(res) =>
                {
                  ...
                  {
                      this.DataList = this.ResponseData.dataLoad.data;
