...
@Component({
  selector: 'app-app-loans',
  templateUrl: './app-loans.component.html',
  styleUrls: ['./app-loans.component.css']
})
export class AppLoansComponent extends AppBasedComponent implements OnInit
{
