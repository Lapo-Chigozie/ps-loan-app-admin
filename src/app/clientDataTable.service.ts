...
export class ClientDataTableService 
{
    ...
    private MaxRetriever :number = 100;
      ...
      public MaxStatusRetriever :string = 'Active';
  ...
  public async LoadClientNetPayHeader(ClientId:any , PagenationFilter:any): Promise<void> 
  {
        ...
        await this.LapoLoanService.GetClientNetPayConnector(PagenationFilter).subscribe({
        next:(res)=>
        {
