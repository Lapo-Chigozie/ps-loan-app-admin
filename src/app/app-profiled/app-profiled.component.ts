...
@Component({
  selector: 'app-app-profiled',
  templateUrl: './app-profiled.component.html',
  styleUrls: ['./app-profiled.component.css']
})
export class AppProfiledComponent implements OnInit
{
