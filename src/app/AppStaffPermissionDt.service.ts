...
export class AppStaffPermissionDtService 
{
    ...
    private MaxRetriever :number = 100;
      ...
      private MaxStatusRetriever: string = 'Active';
  ...
  private async GetAllLoanApplys(ClientId:any , PagenationFilter:any): Promise<void> 
  {
         // GetLoanAppDetails
         this.AcctId = LocalStorageService.getLoginSessionIdentity(StaticData.LoginKeySession);
        ...
        await this.LapoLoanService.GetAllStaffList(PagenationFilter).subscribe({
        next:(res)=>
        {
