import { Component, EventEmitter, Inject, Input, LOCALE_ID, OnDestroy, OnInit, Output, inject } from '@angular/core';
...
export class AppBasedComponent implements OnInit, OnDestroy  
{
  ...
  constructor( @Inject(LOCALE_ID) public locale: string, public location: Location,  public appRouter: AppRouterService,  public  loadingService: SpinnerService, public  router: Router, public  route: ActivatedRoute, public  formBuilder: FormBuilder, public  LapoLoanService: AdminserviceService, public  fileUploadService: FileUploadServiceService) 
  {
  ...
  public BasedonSignOut(event:any)
  {
  ...
  private BasedonNaviagateBack(page:string)
  {
           ...
           next:(res:any) =>
           {
                  ...
                  if(this.ResponseData != null && this.ResponseData.isActive)
                  {
                    ...
                    this.LoginUserPermission.AccessRightToProceedLoan = this.ResponseData.dataLoad.accessRightToProceedLoan;
                     ...
                     this.LoginUserPermission.AccessRighttoapprovecustomerloan = this.ResponseData.dataLoad.accessRighttoapprovecustomerloan;
                     this.LoginUserPermission.AccessRighttocreateahub = this.ResponseData.dataLoad.accessRighttocreateahub;
                     this.LoginUserPermission.AccessRighttocreateateammember = this.ResponseData.dataLoad.accessRighttocreateateammember;
                     this.LoginUserPermission.AccessRighttocreatetenure = this.ResponseData.dataLoad.accessRighttocreatetenure;
                     this.LoginUserPermission.AccessRighttodisablecustomerstoapplyforaloan = this.ResponseData.dataLoad.accessRighttodisablecustomerstoapplyforaloan;
                     this.LoginUserPermission.AccessRighttodisablehubs = this.ResponseData.dataLoad.accessRighttodisablehubs;
                     this.LoginUserPermission.AccessRightToEditTeamMemberPermissions= this.ResponseData.dataLoad.accessRightToEditTeamMemberPermissions;
                     this.LoginUserPermission.AccessRightToExportDisbursementloan1 = this.ResponseData.dataLoad.accessRightToExportDisbursementloan;
                     this.LoginUserPermission.AccessRighttoloansettings = this.ResponseData.dataLoad.accessRighttoloansettings;
                     this.LoginUserPermission.AccessRighttorejectaloan = this.ResponseData.dataLoad.accessRighttorejectaloan;
                     this.LoginUserPermission.AccessRighttoteamsAndpermissions = this.ResponseData.dataLoad.accessRighttoteamsAndpermissions;
                     this.LoginUserPermission.AccessRightToUploadBackDisbursementloan = this.ResponseData.dataLoad.accessRightToUploadBackDisbursementloan;
                     this.LoginUserPermission.AccessRighttoviewveammembers = this.ResponseData.dataLoad.accessRighttoviewveammembers;
                     this.LoginUserPermission.AccessRighttoviewcustomersloans = this.ResponseData.dataLoad.accessRighttoviewcustomersloans;
                     this.LoginUserPermission.AccessRighttoviewcustomers = this.ResponseData.dataLoad.accessRighttoviewcustomers;
                     this.LoginUserPermission.AccessRighttoviewhubs = this.ResponseData.dataLoad.accessRighttoviewhubs;
                     this.LoginUserPermission.AccessRighttoviewloandetails = this.ResponseData.dataLoad.accessRighttoviewloandetails;
                     this.LoginUserPermission.AccessRighttoviewtenure = this.ResponseData.dataLoad.accessRighttoviewtenure;
                     this.LoginUserPermission.CreateLoanNarration = this.ResponseData.dataLoad.createLoanNarration;
                     this.LoginUserPermission.ViewLoanNarration = this.ResponseData.dataLoad.viewLoanNarration;
