...
@Component({
  selector: 'app-disbursementTeams',
  templateUrl: './disbursementTeams.component.html',
  styleUrls: ['./disbursementTeams.component.css']
})


export class DisbursementTeamsComponent  extends AppBasedComponent implements OnInit 
{
  ...
  override ngOnInit(): void 
  {
        ...
        this.urlhost += AppConfig.HubTeam +  '/HubTeamsDisbursmentOfficers';
